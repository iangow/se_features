...
from topic_add import get_topics
import pandas as pd
import os
    ...
    if table_exists:
        ...
        sql = """CREATE TABLE %s.%s
                (
                    ...
                    market boolean,
                    competition boolean,
                    industry_structure boolean,
                    strategic_intent boolean,
                    innovation_and_r_d boolean,
                    mode_of_entry boolean,
                    ...
                    media boolean,
                    advertising boolean, 
                    corporate_image boolean,
                    financial_performance boolean,
                    forecasting boolean,
                    insider_stock_transactions boolean,
                    regulation boolean,
                    special_interest_groups boolean,
...
res = pool.map(get_topics, files_input)

engine = create_engine(conn_string)
conn = engine.connect()
db_comment = "CREATED USING topic/topic_run.py from " + \
